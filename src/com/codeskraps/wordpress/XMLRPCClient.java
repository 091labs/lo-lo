...
public class XMLRPCClient {
	...
	public XMLRPCClient(URI uri, String httpuser, String httppasswd) {
		...
		postMethod.addHeader("User-Agent", "wp-android/" + "2.2.3");
	 ...
	 */
	public Object call(String method, Object p0, Object p1, Object p2, Object p3, Object p4,
			Object p5) throws XMLRPCException {
	 ...
	 */
	public Object call(String method, Object p0, Object p1, Object p2, Object p3, Object p4,
			Object p5, Object p6) throws XMLRPCException {
	 ...
	 */
	public Object call(String method, Object p0, Object p1, Object p2, Object p3, Object p4,
			Object p5, Object p6, Object p7) throws XMLRPCException {
	...
	private Object callXMLRPC(String method, Object[] params, File tempFile) throws XMLRPCException {
		try {
			...
			if (method.equals("wp.uploadFile")) {
				...
				if (!tempFile.exists() && !tempFile.mkdirs()) { throw new XMLRPCException(
			...
			if (statusCode != HttpStatus.SC_OK) { throw new XMLRPCException("HTTP status code: "
					+ statusCode + " was returned. " + response.getStatusLine().getReasonPhrase()); }
			...
			// Many WordPress configs can output junk before the xml response
			// (php warnings for example), this cleans it.
			int bomCheck = -1;
			int stopper = 0;
			while ((bomCheck = is.read()) != -1 && stopper <= 5000) {
				...
				if (bomCheck == 60) {
					...
					if (snippet.equals("?xml")) {
						...
						// keep searching...
						List<InputStream> streams = Arrays.asList(
								new ByteArrayInputStream(snippet.getBytes()), is);
						is = new SequenceInputStream(Collections.enumeration(streams));
					}
				}
			}
